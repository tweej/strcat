...
static void BM_Unoptimized_ShortStringLiteral_10(benchmark::State& state) {
    for(auto _ : state) {
...
static void BM_Unoptimized_LongStringLiteral_2(benchmark::State& state) {
    for(auto _ : state) {
...
static void BM_Unoptimized_LongStringLiteral_10(benchmark::State& state) {
    for(auto _ : state) {
        std::string s = std::string("012345678901234567890123456789") +
            "123456789012345678901234567890" + "234567890123456789012345678901" +
            "345678901234567890123456789012" + "456789012345678901234567890123" +
...
static void BM_Unoptimized_ShortStrPtr_2(benchmark::State& state) {
...
static void BM_Unoptimized_ShortStrPtr_10(benchmark::State& state) {
    // Pretend we don't know the length of the pointed-to strings
    const char * const s0 = "foo";
    const char * const s1 = "bar";
...
static void BM_Unoptimized_LongStrPtr_2(benchmark::State& state) {
    // Pretend we don't know the length of the pointed-to strings
...
static void BM_Unoptimized_LongStrPtr_10(benchmark::State& state) {
    // Pretend we don't know the length of the pointed-to strings
    const char * const s0 = "012345678901234567890123456789";
    const char * const s1 = "123456789012345678901234567890";
...
static void BM_Unoptimized_ShortSTLStr_2(benchmark::State& state) {
...
static void BM_Unoptimized_ShortSTLStr_10(benchmark::State& state) {
    const std::string s0{"foo"};
    const std::string s1{"bar"};
...
static void BM_Unoptimized_LongSTLStr_2(benchmark::State& state) {
...
static void BM_Unoptimized_LongSTLStr_10(benchmark::State& state) {
    const std::string s0{"012345678901234567890123456789"};
    const std::string s1{"123456789012345678901234567890"};
